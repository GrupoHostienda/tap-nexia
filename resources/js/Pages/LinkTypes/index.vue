...
const saveItem = () => {
    ...
    form.post(`/link-types`, {
        onSuccess: () => {
            toast.add({severity:'success', summary: 'Successful', detail: 'Link type Created', life: 3000});
            itemDialog.value = false;
        },
        onError: (error) => {
            console.log(error);
...
const updateItem = (form) => {
    ...
    form.post(`/link-types/update`, {
        onSuccess: () => {
            toast.add({severity:'success', summary: 'Successful', detail: 'Link type Updated', life: 3000});
            itemDialog.value = false;
        },
        onError: (error) => {
            console.log(error);
...
const deleteItem = () => {
    ...
    form.delete(`/link-types/${item.value.id}`, {
        onSuccess: () => {
            toast.add({severity:'success', summary: 'Successful', detail: 'Link type Deleted', life: 3000});
        },
        onError: (error) => {
            console.log(error);
        },
...
const deleteSelectedItems = () => {
    ...
    console.log(form)
    form.delete(`/link-types/deleteSelected`, {
        onSuccess: () => {
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <h2 class="text-2xl font-bold mb-4">Link type</h2>
                    ...
                    <div>
                        <div class="card">
                            ...
                            <DataTable ref="dt" :value="linkTypes" v-model:selection="selectedItems" dataKey="id"
